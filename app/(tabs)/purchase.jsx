...
export default function PurchaseScreen() {
  ...
  const handleDownloadA4Invoice = async (purchase, layoutType = 'modern') => {
    if (!purchase) return;
    ...
    const html = layoutType === 'classic'
      ? generateClassicA4HTML(purchase, products, false, settings)
      : generateModernA4HTML(purchase, products, false, settings);
          ...
          <View className="bg-white rounded-3xl p-6 w-full max-w-sm shadow-2xl">
            ...
            <View className="gap-3">
              ...
              <View style={{ flexDirection: "row", justifyContent: "space-between", width: "100%", gap: 12 }}>
                <TouchableOpacity
                  onPress={() => handleDownloadA4Invoice(completedPurchase, 'modern')}
                  activeOpacity={0.8}
                  style={{ flex: 1, backgroundColor: "#1e293b", borderRadius: 16, paddingVertical: 14, alignItems: "center", flexDirection: "row", justifyContent: "center" }}
                >
                ...
                <TouchableOpacity
                  onPress={() => handleDownloadA4Invoice(completedPurchase, 'classic')}
                  activeOpacity={0.8}
                  style={{ flex: 1, backgroundColor: "#334155", borderRadius: 16, paddingVertical: 14, alignItems: "center", flexDirection: "row", justifyContent: "center" }}
                >
                  <Ionicons name="document-text-outline" size={15} color="#fff" style={{ marginRight: 6 }} />
                  <Text style={{ color: "#fff", fontSize: 11, fontWeight: "900", textTransform: "uppercase", letterSpacing: 1 }}>
                    Classic A4
